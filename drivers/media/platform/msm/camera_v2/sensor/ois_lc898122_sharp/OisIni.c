...
#ifdef	USE_VH_SYNC
	RegWriteA( STROBEFC,	0x80 ) ;				// 0x001C	\8AO\95\94\93\FC\97\CDStrobe\90M\8D\86\82̗L\8C\F8
...
void	IniGyr( void )
{
	...
	RegWriteA( WG_SHTON	, 0x10 );						// 0x0107		[ - | - | - | CmSht2PanOff ][ - | - | CmShtOpe(1:0) ]
														//				CmShtOpe[1:0] 00: \83V\83\83\83b\83^\81[OFF, 01: \83V\83\83\83b\83^\81[ON, 1x:\8AO\95\94\90\A7\8C\E4
	...
	RegWriteA( WG_LMT3MOD , 0x00 );						// 0x0118 	[ - | - | - | - ][ - | - | - | CmLmt3Mod ]
														//				CmLmt3Mod	0: \92ʏ탊\83~\83b\83^\81[\93\AE\8D\EC, 1: \89~\82̔\BC\8Ca\83\8A\83~\83b\83^\81[\93\AE\8D\EC
	RegWriteA( WG_VREFADD , 0x12 );						// 0x0119	 	\83Z\83\93\83^\81[\96߂\B5\82\F0\8Ds\82\A4\92x\89\84RAM\82̃A\83h\83\8C\83X\89\BA\88\CA6\83r\83b\83g\81@(default 0x12 = GXH1Z2/GYH1Z2)
#endif
	...
	RamWrite32A( gylmt4HS0, GYRLMT4_S1 ) ;				// 0x112B	Y\8E\B2Limiter4 High臒l0
	RamWrite32A( gxlmt4HS0, GYRLMT4_S1 ) ;				// 0x102B	X\8E\B2Limiter4 High臒l0
	
	RamWrite32A( gxlmt4HS1, GYRLMT4_S2 ) ;				// 0x102C	X\8E\B2Limiter4 High臒l1
	RamWrite32A( gylmt4HS1, GYRLMT4_S2 ) ;				// 0x112C	Y\8E\B2Limiter4 High臒l1
	...
	RegWriteA( WG_PANSTT4TMR1,	0x0A );					// 0x013F
    #else	//PT_TEST_01
	RegWriteA( WG_PANSTT4TMR0,	0x02 );					// 0x013E
...
#ifdef	NEW_PTST
	UnGyrLmt.SfFltVal	= 0.003F ;						// St4 Limiter\81@1/S\81\AB
...
//	RegWriteA( WG_VREFADD , 0x12 );						// 0x0119
	...
	// Pan/Tilt NEW\81@PanTilt\81@Setteing
	RegWriteA( WG_NPANST12BTMR, 0x0F ) ;				// 0x0167 
	RegWriteA( WG_NPANST3RTMR, 0x0A ) ;					// 0x0166 
	RegWriteA( WG_NPANST12TMRX, 0x00 ) ;				// 0x0168 682u:682\83\CA
	RegWriteA( WG_NPANST12TMRY, 0x00 ) ;				// 0x0169 682u:682\83\CA
	...
	RegWriteA( WG_NPANINITMR, 0x02 ) ;					// 0x016F 21ms '\95]\89\BF\8E\9E\82Ɍ\9F\93\A2\8C\BB\8D݂͓\AF\82\B6\92l
	...
	RamWrite32A( gxistp_2d, UnGyrLmt.UlLngVal );		// 0x1087	ST1,ST3\81@Ccof Val
	RamWrite32A( gyistp_2d, UnGyrLmt.UlLngVal );		// 0x1187	ST1,ST3\81@Ccof Val
	UnGyrLmt.UlLngVal = 0x3F7FFE80 ;
	RamWrite32A( gyistp_2u, UnGyrLmt.UlLngVal );		// 0x1188	ST2,ST4\81@Ccof Val
	RamWrite32A( gxistp_2u, UnGyrLmt.UlLngVal );		// 0x1088	ST2,ST4\81@Ccof Val
...
void	IniAdj( void )
{
	...
	/* OIS */
	RegWriteA( CMSDAC0, BIAS_CUR_OIS ) ;		// 0x0251	Hall Dac\93d\97\AC
	RegWriteA( OPGSEL0, AMP_GAIN_X ) ;			// 0x0253	Hall amp Gain X
	RegWriteA( OPGSEL1, AMP_GAIN_Y ) ;			// 0x0254	Hall amp Gain Y
	/* AF */
	RegWriteA( CMSDAC1, BIAS_CUR_AF ) ;			// 0x0252	Hall Dac\93d\97\AC
...
void	ClrGyr( unsigned short UsClrFil , unsigned char UcClrMod )
{
	...
	/*Enable Clear*/
	RegWriteA( WC_RAMINITON	, UcClrMod ) ;	// 0x0102	[ - | - | - | - ][ - | - | \92x\89\84Clr | \8CW\90\94Clr ]
...
void	IniPtMovMod( unsigned char UcPtMod )
{
	switch ( UcPtMod ) {
		case OFF :
			...
			RegWriteA( WG_PANSTTSETGAIN, 	0x5C );		// 0x0155
