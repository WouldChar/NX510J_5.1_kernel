...
#define CONFIG_DISABLE_KEYS_AT_SUSPEND
#define CONFIG_DISABLE_TIMER_AT_SUSPEND
...
ssize_t zte_plugin_proci_pi_gesture_show(struct plugin_proci *p, char *buf, size_t count);//ZTEMT add , judge all of gesture
