...
static int plugin_misc_get_pid_name(struct plugin_misc *p, char *name, int len)
{
	...
	if (idx >= 0 && idx < pid_cfg->num_name) {
		dev_info(dev, "mxt get pid name %s\n", pid_cfg->name_list[idx].name);
...
static struct pid_name pid_name_map_list[] = {
	{"00.p",{0x0}},   //ZERO id is default for invalid PID, must be first
	{"02.p",{0x0,0x0,0xFF,0x3}},
	{"02.p",{0x0,0x0,0x0,0x4}},
	{"02.p",{0x0,0x0,0x0,0x5}},
	{"03.p",{0x0,0x0,0x0,0x6}},
	{"03.p",{0x0,0x0,0xFF,0x6}},
	{"03.p",{0x0,0x0,0x00,0x7}},
	{"03.p",{0x0,0x0,0x00,0x8}},
	{"03.p",{0x0,0x0,0x00,0x9}},
	{"03.p",{0x0,0x0,0xFF,0xC}},
	{"04.t",{0x0,0x0,0x00,0x0A}},
	{"04.t",{0x0,0x0,0x00,0x0B}},
	{"04.t",{0x0,0x0,0x00,0x0D}},
	{"04.t",{0x0,0x0,0x00,0x0E}},
	{"04.t",{0x0,0x0,0x00,0x0F}},
	{"04.t",{0x0,0x0,0x00,0x10}},
	{"04.t",{0x0,0x0,0x00,0x11}},
	{"04.t",{0x0,0x0,0x00,0x12}},
	{"04.t",{0x0,0x0,0x00,0x13}},
	{"04.t",{0x0,0x0,0x00,0x14}},
...
static int plugin_misc_init(struct plugin_misc *p, unsigned long pl_flag)
{
	const struct mxt_config *dcfg = p->dcfg;
	struct device *dev = dcfg->dev;
...
static void plugin_misc_deinit(struct plugin_misc *p)
{
	deinit_msc_object(p);
...
static struct plugin_misc mxt_plugin_misc_if = 
{
	.init = plugin_misc_init,
	.deinit = plugin_misc_deinit,
	.start = NULL,
	.stop = NULL,
...
int plugin_interface_misc_init(struct plugin_misc *p)
{
	memcpy(p, &mxt_plugin_misc_if, sizeof(struct plugin_misc));
